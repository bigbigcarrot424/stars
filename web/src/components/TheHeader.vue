<template>
    <a-layout-header :style="{ zIndex: 1, width: '100%', position: 'fixed',}">
        ...
        >
            ...
            <a-menu-item key="2" v-if="!!user.id"><router-link to="/follow">动态</router-link></a-menu-item>
            <a-menu-item key="3" v-if="!!user.id"><router-link to="/publish">发帖</router-link></a-menu-item>
            <a-menu-item key="4" v-if="!!user.id"><router-link to="/myBlog">我的帖子</router-link></a-menu-item>
            <a-menu-item key="10" v-if="!!user.id"><router-link to="/circles">兴趣圈</router-link></a-menu-item>
            <a-menu-item key="6" v-if="!!user.id"><router-link to="/adminCollect">收藏</router-link></a-menu-item>
            <a-menu-item key="5" v-if="!!user.id"><router-link to="/myFriend">关注列表</router-link></a-menu-item>
            <a-menu-item key="11" v-if="!!user.id"><router-link to="/explore">发现</router-link></a-menu-item>
            <a-menu-item key="7" v-if="!user.id" :style="{marginLeft:'auto'}"><a-button type="text" @click="popSignIn">登录</a-button></a-menu-item>
            <a-menu-item key="8" v-if="!user.id"><a-button type="text" @click="popSignUp">注册</a-button></a-menu-item>
